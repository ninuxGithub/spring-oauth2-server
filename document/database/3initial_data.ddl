...
insert into user_(id,client_id,guid,create_time,email,password,phone,username,default_user)
values
...
insert into user_(id,client_id,guid,create_time,email,password,phone,username,default_user)
values
(22,'unity_client','55b713df1c6f423e842ad68668523c49',now(),'unity@wdcy.cc','439b3a25b555b3bc8667a09a036ae70c','','unity',false);
...
insert into user_(id,client_id,guid,create_time,email,password,phone,username,default_user)
values
(23,'mobile_client','612025cb3f964a64a48bbdf77e53c2c1',now(),'mobile@wdcy.cc','532c28d5412dd75bf975fb951c740a30','','mobile',false);
