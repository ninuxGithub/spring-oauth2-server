...
public class ClientDetailsController {
    ...
    public String clientDetails(Model model) {
        ...
        //System.out.println("clientDetailsDtoList-->"+clientDetailsDtoList);
    ...
    * */
    ...
    public String updateClientReource(@PathVariable("clientId") String clientId, Model model){
        ...
        System.err.println("-->"+ clientDetailsDto);
        
        return "clientdetails/update_client";
    }
    
    @RequestMapping(value = "/submitUpdate", method = RequestMethod.POST)
    public String submitUpdate(@ModelAttribute("formDto") OauthClientDetailsDto formDto, BindingResult result, Model model){
