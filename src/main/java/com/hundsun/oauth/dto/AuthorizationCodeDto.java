...
public class AuthorizationCodeDto implements Serializable {
	...
	private static final long serialVersionUID = -1566299209870760858L;
	...
	public String toString() {
		return "AuthorizationCodeDto [userAuthorizationUri=" + userAuthorizationUri + ", responseType=" + responseType
				+ ", scope=" + scope + ", clientId=" + clientId + ", redirectUri=" + redirectUri + ", state=" + state
				+ "]";
	}
