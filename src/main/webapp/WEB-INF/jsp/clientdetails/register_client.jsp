...
<body>
	...
	<div ng-app="register_client">
		<p class="help-block">
			...
			中的属性及作用不清楚, 建议你先查看项目中的
			<code>table_description.html</code>
			文件(位于others目录)中对表
			<code>oauth_client_details</code>
			的说明, 或在线访问<a
				href="${pageContext.request.contextPath}/user/table_description"
				target="_blank">table_description.html</a>;
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<div class="col-sm-10">
							...
							<p class="help-block">Select Privilege(s). privilege is form security.xml </p>
						</div>
					</div>
				</div>
