...
<div ng-app>
    ...
    <div ng-controller="UpdateClientCtrl">
        <form:form action="${pageContext.request.contextPath}/submitUpdate" commandName="formDto" cssClass="form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    ...
                    <label class="checkbox-inline">
                        <input type="checkbox" name="authorizedGrantTypes"
                               value="password" ${fun:containsIgnoreCase(formDto.authorizedGrantTypes, 'password') ?'checked':''} />
                        password
                    </label>
                    <label class="checkbox-inline">
                        <input type="checkbox" name="authorizedGrantTypes"
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <form:select path="authorities" id="authorities" cssClass="form-control">
                        ...
                        <form:option value="ROLE_USER,ROLE_UNITY,ROLE_MOBILE,ROLE_ADMIN">ROLE_UNITY,ROLE_MOBILE</form:option>
                    </form:select>
            ...
            <div ng-show="visible">
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <form:input type="number" class="form-control" path="accessTokenValidity" id="accessTokenValidity"
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <form:input type="number" class="form-control" path="refreshTokenValidity" id="refreshTokenValidity"
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <form:input type="text" class="form-control" path="additionalInformation" id="additionalInformation"
