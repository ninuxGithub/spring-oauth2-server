...
<body>
	...
	<h2>
		authorization_code <small>用 'access_token' 去访问
			spring-oauth-server 的API</small>
	</h2>
	<br />
	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			<dl class="dl-horizontal">
				<dt>access_token</dt>
				<dd>
					<code>${accessTokenDto.accessToken}</code>
				</dd>
				<dt>token_type</dt>
				<dd>
					<code>${accessTokenDto.tokenType}</code>
				</dd>
				<dt>refresh_token</dt>
				<dd>
					<code>${accessTokenDto.refreshToken}</code>
				</dd>
				<dt>scope</dt>
				<dd>
					<code>${accessTokenDto.scope}</code>
				</dd>
				<dt>expires_in</dt>
				<dd>
					<code>${accessTokenDto.expiresIn}</code>
				</dd>
			</dl>
			<hr />
			...
			<ul>
				<li>方式1: 调用本地的接口,由后台去向服务器获取资源并进行处理(如将JSON数据转化成对象), 通过页面展示信息 <br />
					<a
					href="${contextPath}/unity/user_info?access_token=${accessTokenDto.accessToken}">Oauth
						Server 用户信息</a>
				</li>
				<li>方式2: 直接通过access_token去访问服务器的资源(该方式将直接获取JSON数据) <br /> <a
					href="${unityUserInfoUri}?access_token=${accessTokenDto.accessToken}"
